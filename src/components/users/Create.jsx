        ...
        <div className="row flex-nowrap">
          ...
          <div className="col py-3">
                 ...
                 {/* <form onSubmit={sendData} >
                     <Input errors={errors} id={'username'} title={'user name'} type={'text'} name={'name'} handleData={handleData} customClasses='bg-danger'/>
                     <Input errors={errors} id={'email'}    title={'user email'} type={'email'} name={'email'} handleData={handleData} customClasses='bg-danger'/>
                     <Input errors={errors} id={'password'}  title={'user password'}  type={'password'} 
                    name='password'   handleData={handleData} customClasses='bg-danger'/>
                    <div className="mb-3">
            ...
            <div className="mb-3">
                ...
                <input type="text" name='name' className="form-control"  onChange={handleData} id="username" />
            </div>

            <div className="mb-3">
                <label htmlFor="email" className="form-label" > user email</label>
                <input type="email" name='email' className="form-control"  onChange={handleData} id="email" />
            </div>

            <div className="mb-3">
                <label htmlFor="password" className="form-label"  > user password</label>
                <input type="password"  name='password'  className="form-control"  onChange={handleData} id="password" />
            </div>
